  ...
  return (
    <div className={clsx(
      ...
      <div className={clsx(
              ...
              {message.content ? (
                <ReactMarkdown
                  ...
                  components={{
                    ...
                    pre: ({ children }) => (
                      <pre className="bg-slate-800 text-slate-100 rounded-lg p-3
                                      overflow-x-auto text-xs my-2 font-mono">
                        {children}
                      </pre>
                    ),
                    code: ({ children, className }) => {
                      ...
                      return (
                        <code className="bg-slate-100 text-indigo-700 px-1 py-0.5
        ...
        {/* Timestamp + provider badge + read aloud button */}
        <div className="flex items-center gap-2 mt-1 px-1">
          ...
          {!isUser && !message.isStreaming && message.content && ttsAvailable && (
            <button
